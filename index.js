...
function addGamesToPage(games) {
    ...
    // loop over each item in the data
        ...
        for (let game of games) {
            ...
            gameCard.innerHTML = `
                <img class="game-img" src="${game.img}" alt="Image of ${game.name}" />
                <h3>${game.name}</h3>
...
function filterUnfundedOnly() {
    ...
    console.log("Unfunded:", unfundedGames.length); // For Challenge 5 key
...
function filterFundedOnly() {
    ...
    console.log("Funded:", fundedGames.length); // For Challenge 5 key
...
infoPara.innerText = companyInfo; // apa haruse bukan haruse descriptionText ya
descriptionContainer.appendChild(infoPara);
